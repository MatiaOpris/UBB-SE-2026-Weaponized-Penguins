...
namespace Boards_WP.ViewModels
{
    public partial class BetsViewModel : ObservableObject
    {
        ...
        private void LoadHomeBets()
        {
            ...
            var currentUserId = _userSession?.CurrentUser?.UserID ?? DefaultUserId;
        ...
        private void LoadCurrentUserBets()
        {
            ...
            var currentUserId = _userSession?.CurrentUser?.UserID ?? NoUserId;
            if (currentUserId == NoUserId) return;
