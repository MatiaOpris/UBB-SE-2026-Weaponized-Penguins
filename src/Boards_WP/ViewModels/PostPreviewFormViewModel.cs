...
namespace Boards_WP.ViewModels
{
    public partial class PostPreviewViewModel : ObservableObject
    {
        ...
        private const int DescriptionPreviewLength = 150;
        public string DescriptionSnippet
        {
            get
            {
                if (string.IsNullOrEmpty(PostData?.Description)) return string.Empty;
                return PostData.Description.Length > DescriptionPreviewLength
                    ? PostData.Description.Substring(0, DescriptionPreviewLength) + "..."
